const U = (o, t = {}, E = {}) => {
  ...
  const u = t?.options?.minMove || 5, L = t?.options?.minDist || 60, P = t?.options?.maxDuration || 280, g = t?.options?.minVelocity || 0.5, M = (e) => {
    e.target.setPointerCapture(e.pointerId), !(t?.beforeEvent && !t.beforeEvent(e)) && (i = e.clientX, s = e.clientY, w = performance.now(), t.down && t.down({ sx: i, sy: s, st: w, e }), t?.afterEvent && t.afterEvent(e));
  }, X = (e) => {
